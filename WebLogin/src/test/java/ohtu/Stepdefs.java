...
public class Stepdefs {
    ...
    public void valid_username_and_password_are_given(String username, String password){
    ...
    @When("^taken username \"([^\"]*)\" and valid password \"([^\"]*)\" and matching password confirmation are entered$")
    public void taken_username_and_valid_password_are_given(String username, String password) throws Throwable {
        createUser(username, password, password);
    }
    
    @When("^valid username \"([^\"]*)\" and password \"([^\"]*)\" and invalid password confirmation \"([^\"]*)\" are entered$")
    public void valid_username_and_password_and_invalid_confirmation_are_given(String username, String password, String confirmation) throws Throwable {
